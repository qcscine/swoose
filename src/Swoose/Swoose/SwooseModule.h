 ...
 */
#ifndef SWOOSE_MODULE_H
#define SWOOSE_MODULE_H
...
/**
 * @class SwooseModule SwooseModule.h
 * @brief This module provides all features regarding methods that are intended to be applicable to nanoscale systems.
 */
class SwooseModule : public Scine::Core::Module {
 public:
 ...
 */
extern "C" {
const void* moduleFactory = reinterpret_cast<const void*>(reinterpret_cast<intptr_t>(&Scine::Swoose::moduleFactory));
}
#else
BOOST_DLL_ALIAS(Scine::Swoose::moduleFactory, moduleFactory)
#endif

#endif // SWOOSE_MODULE_H
